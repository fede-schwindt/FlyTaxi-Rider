...
/* harmony import */ var _angular_fire_auth__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @angular/fire/auth */ 3628);
...
let LoginPage = class LoginPage {
  ...
  loginWithGoogle() {
    ...
    return (0,_workspaces_FlyTaxi_Rider_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        _this3.approve = true;
        let googleUser = yield _codetrix_studio_capacitor_google_auth__WEBPACK_IMPORTED_MODULE_7__.GoogleAuth.signIn();
        ...
        const sToken = yield (0,_angular_fire_auth__WEBPACK_IMPORTED_MODULE_14__.signInWithCredential)(_this3.authY, credential);
        ...
        if (sToken.user.phoneNumber) {
          ...
          yield (0,_angular_fire_auth__WEBPACK_IMPORTED_MODULE_14__.deleteUser)(_this3.authY.currentUser);
...
LoginPage.ctorParameters = () => [{
  ...
  type: _angular_fire_auth__WEBPACK_IMPORTED_MODULE_14__.Auth
}, {
...
LoginPage = (0,tslib__WEBPACK_IMPORTED_MODULE_17__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_18__.Component)({
  selector: 'app-login',
...
module.exports = "@keyframes slide-left {\n  0% {\n    transform: translateX(0);\n  }\n  100% {\n    transform: translateX(-100px);\n  }\n}\n@keyframes slide-right {\n  0% {\n    transform: translateX(0);\n  }\n  100% {\n    transform: translateX(100px);\n  }\n}\n.slide-left {\n  animation: slide-left 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94) both;\n}\n.slide-right {\n  animation: slide-right 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94) both;\n}\nion-footer ion-row {\n  background: transparent;\n  display: block;\n}\nion-footer ion-row ion-fab-button {\n  margin-right: 2.5vh;\n}\nion-footer ion-row ion-list ion-list-header ion-label {\n  font-weight: bold;\n  font-size: 1.8rem;\n}\nion-footer ion-row ion-list ion-input, ion-footer ion-row ion-list ion-text {\n  font-size: 1.3rem;\n}\nion-footer ion-row ion-list .error {\n  font-size: 0.75em !important;\n}\nion-toolbar, ion-header {\n  height: 44px;\n}\nion-img {\n  margin: auto;\n  width: auto;\n}\nion-slides {\n  height: 440px;\n}\nion-select {\n  color: var(--ion-color-primary);\n  --placeholder-opacity: 1;\n  width: 30%;\n  justify-content: center;\n  font-size: 24px;\n  font-weight: 500;\n}\n.pm-awesome-divider {\n  width: 100%;\n  text-align: center;\n  margin-top: 20px;\n}\n.shadow-top {\n  box-shadow: 0px -1.5px 1.5px rgba(196, 196, 196, 0.414);\n}\n/*# sourceMappingURL=data:application/json;base64, */";
